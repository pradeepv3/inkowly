<?php include("_header2.php"); ?>
	...
	<section class="m-content-wrapper sec-subpage-main sec-services">
		...
		<div class="section text-center sec-divider clearfix">
			<div class="container">
		...
		<div class="section clearfix">
			<div class="container sec-testimonial">
				<h3 class="sec-title br-line text-center">What clients say?</h3>
				<div class="col-sm-6">
					<div class="sec-textimonial__content text-center">
						<div class="sec-textimonial__avatar">
							<img src="images/no_image.jpg" />
						</div>
						<div class="sec-textimonial__text">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
						</div>
						<div class="sec-textimonial__name">
							Meut Ozil
						</div>
						<div class="sec-textimonial__company">
							Arsenal
						</div>
					</div>
				</div>
