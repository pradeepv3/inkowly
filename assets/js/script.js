...
(function ($) {
    ...
    IOY.Counter = function () {
        ...
        $(window).scroll(function () {
            ...
            if (a == 0 && $(window).scrollTop() > oTop) {
                $('.sec-countdown__count').each(function () {
                    var $this = $(this),
    ...
    $(function () {
        ...
        $(window).scroll(function () {
            if ($('.two-col-promo').length && $('.two-col-promo .two-col-promo_title').IsInViewport()) {
                $('.two-col-promo .two-col-promo_title').addClass($('.two-col-promo .two-col-promo_title').attr('data-animate'));
            }
        });

        $('.sec-countdown__count').length && IOY.Counter();
