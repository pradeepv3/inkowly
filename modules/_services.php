<div class="section sec-services">
	<div class="container text-center">
		...
		<div class="row">
			<div class="col-12 col-xws-6 col-sm-6 col-lg-3 mb-sm-3 sec-services__item wow fadeInRight">
				<div>
			...
			<div class="col-12 col-xws-6 col-sm-6 col-lg-3 mb-sm-3 sec-services__item wow fadeIn">
				<div>
					<div class="circle-icon sec-services__icon">
			...
			<div class="col-12 col-xws-6 col-sm-6 col-lg-3 sec-services__item wow fadeIn">
				<div>
					<div class="circle-icon sec-services__icon">
			...
			<div class="col-12 col-xws-6 col-sm-6 col-lg-3 sec-services__item wow fadeInLeft">
				<div>
					<div class="circle-icon sec-services__icon">
