<div class="post-entry clearfix">
	<div class="post-entry__pic">
		...
		<h3 class="post-entry__title">
			...
			<span>Vestibulum eu nisi quis ipsum egestas cursus nec eget quam</span>
		</h3>
	</div>
	...
	<div class="container">
		<div class="col-xs-12 ">
			...
			<div class="post-entry-content">
				...
				<p class="post-entry__excrept">Maecenas suscipit diam vitae magna placerat, non venenatis mi aliquet. Nullam id nisl eget tellus mollis fermentum at
					...
					vel urna pharetra, finibus aliquet neque. Integer aliquam vestibulum magna. Pellentesque habitant morbi tristique senectus
					et netus et malesuada fames ac turpis egestas. Quisque at lorem non justo facilisis facilisis at quis quam. Vivamus
					facilisis enim vitae magna molestie laoreet. Nulla faucibus sodales massa at convallis. </p>
		...
		<?php 
			include("modules/blog/_blog-comment-form.php"); 
			include("modules/blog/_blog-comments.php"); 
		?>
	</div>
